 ...
 */
public class RoutingTablePeers extends RoutingTable<KBucket> {
     ...
     * @param nodeOwner
     */
    public RoutingTablePeers(PeerNode nodeOwner){
        new RoutingTablePeers(nodeOwner, nodeOwner.keyLength());
    }
     ...
     */
    public RoutingTablePeers(PeerNode nodeOwner, int sizeTable){
     ...
     */
    public PeerNode getNodeOwner(){ return nodeOwner; }
     ...
     */
    @Override
    public Node getClosest(PeerNode node) {
     ...
     */
    @Override
    public Node[] getKClosest(PeerNode node) {
        int position;
